...
const prescriptions_controller_js_1 = require("./prescriptions.controller.js");
const prescriptions_service_js_1 = require("./prescriptions.service.js");
...
exports.PrescriptionsModule = PrescriptionsModule = __decorate([
    (0, common_1.Module)({
        ...
        controllers: [prescriptions_controller_js_1.PrescriptionsController],
        providers: [prescriptions_service_js_1.PrescriptionsService],
    })
], PrescriptionsModule);
