...
import { PharmacistPrescriptionsController } from './controllers/pharmacist-prescriptions.controller.js';
...
@Module({
  ...
  controllers: [
    ...
    PharmacistPrescriptionsController,
  ...
  providers: [
    ...
    PharmacistPrescriptionsService,
